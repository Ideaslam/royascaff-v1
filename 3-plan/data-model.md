...
This document defines the complete MongoDB and Mongoose data model for **Roya AI Dynamo**, an AI-powered SaaS dashboard generation platform. The model is derived from `1-description.md`, `3-plan/modules.md`, `3-plan/features.md`, and `5-rules/custom-feature-rules.md`. It covers all required collections, their field definitions, relationships, indexes, and validation rules.
