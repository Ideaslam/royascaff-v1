...
RoyaScaff ships **`royascaff/engine/` only**. `project/` is generated by the engine (not pre-seeded).
Layout contract: `royascaff/engine/project-layout.md`. Router: `royascaff/engine/flow.md`.
...
All flows live under `royascaff/engine/`. Start at `royascaff/engine/flow.md`.
