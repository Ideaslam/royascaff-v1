...
RoyaScaff ships **`.cursor/royascaff/engine/` only**. `project/` is generated by the engine (not pre-seeded).
Layout contract: `.cursor/royascaff/engine/project-layout.md`. Router: `.cursor/royascaff/engine/flow.md`.
...
All flows live under `.cursor/royascaff/engine/`. Start at `.cursor/royascaff/engine/flow.md`.
