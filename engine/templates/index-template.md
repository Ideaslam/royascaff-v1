...
> Read this before scanning a directory. Load only the module files you need. Status values and ID scheme: `.cursor/royascaff/engine/conventions.md`. Layout: `.cursor/royascaff/engine/project-layout.md`.
...
> Status: `planned` · `partial` · `done` · `deferred` — see `.cursor/royascaff/engine/conventions.md`. `Done/Total` counts built vs specced artifacts.
...
- **Status** — the **rolled-up** module status (see rollup rule in `.cursor/royascaff/engine/conventions.md`).
...
> Status: `planned` · `partial` · `done` · `deferred` — see `.cursor/royascaff/engine/conventions.md`. `Done/Total` counts built vs specced endpoints.
