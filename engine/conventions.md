...
**System-specific facts** (framework versions, database, queues, storage, AI/email/payment providers, brand colors, product name, repo paths) live only in generated `project/profile.md`. Never put them in `.cursor/royascaff/engine/`.
