...
This file defines every backend API endpoint for **Roya AI Dynamo**. Endpoints are grouped by module matching `3-plan/modules.md`. All inputs, outputs, auth rules, and constraints are derived from `3-plan/features.md`, `3-plan/data-model.md`, and `5-rules/custom-feature-rules.md`.
