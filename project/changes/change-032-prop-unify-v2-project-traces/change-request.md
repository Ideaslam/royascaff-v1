...
- **part**: 2/3
- **depends-on**: change-031
- **blocks**: change-033 (planned)
- **pack-status**: merged
...
8. Completed v2 proposals remain editable/viewable in archive (change-031 consumers).

## Notes (optional)

- Depends on change-031 merged (archive parity).
