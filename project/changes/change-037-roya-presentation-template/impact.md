...
- Client-first cover / `about_workspace` / footer chrome from change-036
...
- **depends-on**: — (change-005/023/025/036 patterns already in code; 036 verified for client-first)
