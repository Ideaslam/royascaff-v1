...
- Client-first cover / `about_workspace` behavior from change-20260728-000036 should apply (client on cover; agency intro in `about_workspace`; workspace chrome on footer).
