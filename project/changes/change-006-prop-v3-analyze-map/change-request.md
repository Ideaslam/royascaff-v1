...
- **blocks**: change-007 (planned — Steps 3–5 + engine)
- **pack-status**: merged
...
**Depends on** merged `change-004` (schemas, BullMQ, traces, model resolver) and `change-005` (pitch-landscape abstract catalog).
...
**Out of scope:**
- Step 3 parallel section content, assemble, export workers — change-007
- Regenerate-from-step-2 / translate / template-switch product flows — change-008 (basic regenerate-dna OK here)
- Frontend create/stepper — change-009
