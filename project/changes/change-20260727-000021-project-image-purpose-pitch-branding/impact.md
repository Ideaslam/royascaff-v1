...
- **Complete**: wire Settings → template (change-20260727-000020 left this out of scope)
...
## Dependencies
- depends-on: **change-20260727-000020** (soft) — pack-status: `in-progress` 6/6 artifacts; `settings.logoUrl` already in code
