...
- **part**: —
- **depends-on**: change-20260727-000021 (merged — `purpose: client_logo` for AI color fallback)
- **blocks**: —
- **pack-status**: merged
...
4. **DNA branding**
   ...
   - If null/empty → AI (or extraction) builds branding colors from project image(s) with `purpose: client_logo` (change-20260727-000021)
...
- Hard dep on change-20260727-000021 (`client_logo`)
...
- Pack is **blocked** until change-20260727-000021 is `verified` or `merged` (client logo purpose required for AI fallback).
