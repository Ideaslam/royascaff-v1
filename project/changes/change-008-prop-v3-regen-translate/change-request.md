...
- **blocks**: change-009 (planned — FE create/stepper)
- **pack-status**: merged
...
**Depends on** merged `change-007` (sections → assemble → export engine).
...
**Out of scope:**
- Frontend translate/regenerate UI — change-009
...
- `regenerate-dna` endpoint already exists from change-006; this pack adds proposal-level regen/translate/sibling.
