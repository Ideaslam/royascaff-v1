...
**Plan-vs-code:** Main blueprint already documents Templates/PDF modules as partial after change-004 merge.
...
- **Verdict**: Create template render layer; leave pipeline AI steps for change-006
