...
| 056 | 2026-07-13 | modify-feature | customer-portal + backend | Email verification on signup: branded EN/AR templates, check-email + verify-email pages, app banner, API enforcement (403 EMAIL_NOT_VERIFIED), OAuth auto-verify, migration | ✅ PASS | [change-056-email-verification-signup](change-056-email-verification-signup/) |
