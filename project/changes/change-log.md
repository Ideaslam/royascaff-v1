...
|----|------|------|---------|------------|-------------|----------------|-------|--------|
| 20260805-165124 | 2026-08-05 | modify-feature | REQ-SETTINGS-PALETTE | — | drafted | 0/0 | Workspace Theme settings: `app-color-palette` (max 5) + persist `colorRoles` | `change-20260805-165124-workspace-settings-color-palette/` |
