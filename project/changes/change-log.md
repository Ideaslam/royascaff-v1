...
| 010 | 2026-06-24 | general | admin-panel | Admin Panel Complete Modules — Workspaces page, Users page, Clients subscription status column, Subscriptions workspaceId fix + plan filter + card-based plans tab, updated nav + routes | PASS | [change-010-admin-panel-complete-modules](change-010-admin-panel-complete-modules/) |
| 011 | 2026-06-24 | general | all-apps | Split subscriptions and plans pages, fixed legacy MongoDB index duplicate key error when subscribing, wrapped invalid ObjectId query inputs | PASS | [change-011-split-subscriptions-and-plans](change-011-split-subscriptions-and-plans/) |
| 012 | 2026-06-24 | general | all-apps | Show workspace owner & member names/emails, add detailed usage tracking metrics (dashboards, free/extra users), fix payments page render crash, add dashboard stats cards (workspaces, files, updates) | PASS | [change-012-usage-tracking-and-stats](change-012-usage-tracking-and-stats/) |
| 013 | 2026-06-24 | modify-data-model | all-apps | Workspace-scoped projects collection (`ws_{slug}_projects`) — align projects with change-006 multi-tenant pattern; manual migration only | PASS | [change-013-workspace-scoped-projects](change-013-workspace-scoped-projects/) |
