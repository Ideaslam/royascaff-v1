...
Out of scope: the admin-panel UI to edit prompts (future change); provider selection (change-016).
...
## Notes (optional)
- Depends on: none (independent). Consumed by: 019, 020 (pipeline/AI steps reference prompt keys).
