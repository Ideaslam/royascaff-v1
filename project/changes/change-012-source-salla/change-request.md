...
## Description
Add **Salla** by reusing the e-commerce connector framework from Shopify (change-011). Salla orders/products/customers map to the **same canonical flags** but land in **separate OLAP tables** (per A4), unified via canonical views.
...
## Notes (optional)
- Depends on: 001–008, and 011 (e-commerce framework).
