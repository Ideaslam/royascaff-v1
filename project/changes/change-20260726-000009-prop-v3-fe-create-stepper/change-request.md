...
- **part**: 6/8
- **depends-on**: change-20260726-000008
- **blocks**: change-20260726-000010 (planned — AI Requests / cost dashboard UI)
- **pack-status**: merged
...
**Depends on** merged `change-20260726-000008` (regen / translate / sibling APIs).
...
- Restoring `authGuard` on MainLayout (REQ-R change-20260726-000001)
...
4. From proposal/project UI: Retry failed sections, Translate (other lang), and New template (sibling) call the change-20260726-000008 APIs and show progress again.
...
- Part numbering: 6/8 within REQ-PROP-V3 (API parts 1–5 = change-20260726-000004…008).
