...
- **part**: 8/8
- **depends-on**: change-20260726-000010
- **blocks**: —
- **pack-status**: merged
...
Implement **Phase 6 — Cutover & migration** per `docs/refactor-proposal-generator.md` §15 and change-20260726-000004 part map (8/8).

**Depends on** merged `change-20260726-000010` (AI Requests UI).
