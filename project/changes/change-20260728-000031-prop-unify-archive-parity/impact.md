# Impact Analysis — change-20260728-000031-prop-unify-archive-parity
...
- **Pipeline v3** — no engine change; ensure post-export URL maps already present (change-20260726-000013); optional verify-only
...
## Dependencies
- depends-on: — (change-20260726-000013 dual-doc export assumed for new v3 rows; pre-013 rows may still lack financial until re-export / Part 2)
- blocks: change-20260728-000032 (Part 2 — v2 identity + traces)
