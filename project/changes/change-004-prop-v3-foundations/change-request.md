...
- **part**: 1/8
- **depends-on**: —
- **blocks**: change-005 (planned — template system)
- **pack-status**: merged
...
|------|----------------|-----------|--------|
| 1/8 | change-004 (this) | 0 Foundations | Infra + contracts |
| 2/8 | change-005 | 1 Template system | Handlebars + `pitch-landscape` (design-first on disk) |
| 3/8 | change-006 | 2 Steps 1–2 | Analyze + Map; research subset: market, competitor, audience |
| 4/8 | change-007 | 3 Steps 3–5 + engine | Fan-out, assemble, export, reconciler, feature flag |
| 5/8 | change-008 | 4 Regenerate / translate / template-switch | Regeneration APIs; sibling proposals |
| 6/8 | change-009 | 5a Frontend | Project create + template gallery + stepper + PDF download + project workspace (keep legacy create path) |
| 7/8 | change-010 | 5b Frontend | AI Requests / cost dashboard (traces UI) |
| 8/8 | change-011 | 6 Cutover | Backfill, per-workspace flag flip, retire v2 path |
