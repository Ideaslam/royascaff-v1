...
**Problem (bug-20260728-000014):** Users see PayUp (workspace Settings company + logo) on every pitch page and read it as “the client.” Client logo from DNA / Clients record often never appears because assemble only uses `purpose: client_logo` images and project/DNA create seeds `images: []`.
...
- Escalated from `bug-20260728-000014-zid-proposal-shows-payup-branding.md`.
- Reverses the “workspace on every slide” placement from change-20260727-000021 while keeping workspace vars and footer usage.
