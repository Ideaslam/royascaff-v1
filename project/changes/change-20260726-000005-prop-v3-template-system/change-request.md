...
- **part**: 2/8
- **depends-on**: change-20260726-000004
- **blocks**: change-20260726-000006 (planned — Steps 1–2)
- **pack-status**: merged
...
**Depends on** merged `change-20260726-000004` (BullMQ, schemas, PdfRenderService, templates collection shell).
...
- Pipeline steps 1–3 AI (DNA/map/sections) — change-20260726-000006+
- Assemble/export workers wiring into BullMQ — change-20260726-000007
- Second template `pitch-landscape-formal` — change-20260726-000008
- Frontend gallery / create flow — change-20260726-000009
