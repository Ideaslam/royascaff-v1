...
- **part**: —
- **depends-on**: change-20260727-000022 (merged)
- **blocks**: —
- **pack-status**: merged
...
- Related: change-20260727-000022 shipped index→role mapping but left template role assignment + incomplete-slot fallbacks blue-biased.
