...
- **part**: 4/8
- **depends-on**: change-006
- **blocks**: change-008 (planned — regenerate / translate / template-switch)
- **pack-status**: merged
...
- Page(s)/View(s): none (FE later — change-009/010)
...
**Depends on** merged `change-006` (DNA + `sectionMap` + analyze/map workers + Projects API).
...
**Out of scope:**
- Regenerate-from-map / translate / template-switch / formal second template — change-008
- Frontend stepper / PDF download UI / AI Requests page — change-009/010
- Cutover / backfill / retire v2 — change-011
