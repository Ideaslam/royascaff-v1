# Verification — change-031-prop-unify-archive-parity
...
4. Financial visible for completed v3 export — PASS (view tab + list URL maps; empty state if missing). Pre–change-013 rows may still lack financial until re-export (known; Part 2 backfill).
