...
- **part**: —
- **depends-on**: change-020 (soft — code already ships `settings.logoUrl`; pack may still be unmerged)
- **blocks**: —
- **pack-status**: merged
...
- Page(s)/View(s): `web`: Create/Edit Project — images step; (no Settings changes — reuse change-020 logo)
...
- Soft dep on change-020 `logoUrl`
- Auth: `projects.edit`
