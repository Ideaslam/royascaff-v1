# Bug #008 — DNA versions table missing View button
...
## Root Cause
After DNA versions (change-026), row actions only opened the edit form. The legacy DNA viewer (`ProjectDnaComponent`) stayed on project-level `/dna` and was not wired per version.
