# Bug 20260728-000012 — Financials validation still fails (Arabic comma / bidi marks)
...
## Description
After bug-20260728-000010 digit normalization, creative generation still fails with:
