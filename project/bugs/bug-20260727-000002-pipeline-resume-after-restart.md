# Bug 20260727-000002 — Pipeline does not resume after app/Redis stop

## Status
**DONE** — Confirmed 2026-07-27; pack `change-20260727-000015-pipeline-durable-resume/` merged
...
## Triage (6.0)
- **Path A** — change work pack `change-20260727-000015-pipeline-durable-resume/`.
...
## Related Files
See `project/changes/change-20260727-000015-pipeline-durable-resume/merge-report.md`
