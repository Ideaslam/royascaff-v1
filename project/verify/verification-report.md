...
- `engine/rules/backend-rule.md` exists and defines the layering pattern.
- `engine/rules/frontend-rule.md` exists and defines the Angular service pattern.
- `project/rules.md` explicitly mandates integration providers in `src/integrations/` and forbids direct provider calls from controllers or frontend components.
