...
| Shared Infrastructure | shared-infrastructure.md | AppShell, onboardingGuard, Auth Models, Auth Service, WorkspaceService, WorkspaceMembersService, **SideDrawerComponent** *(change-057)* | (cross-cutting) |
