...
- Components: DashboardViewerPage (breadcrumb Projects → project name → dashboard name, title + purpose description, grouped toolbar actions with semantic icons/tooltips — Add widget (AI primary), Layout, Refresh, Share, Export, Delete; edit-mode Save/Cancel; widget grid with chart.js + angular-gridster2, add/edit widget AI dialogs, per-widget AI/Delete/Drag actions in layout mode, share dialog, export menu, AI loader popup)
