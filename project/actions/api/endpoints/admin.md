...
| EP-ADMIN-02 | GET | /api/admin/ai-jobs | authenticated | list query | jobs | AiJobsAdminService | done | |
| EP-ADMIN-03 | GET | /api/admin/ai-jobs/:id | authenticated | param | job | AiJobsAdminService | done | |
