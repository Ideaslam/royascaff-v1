...
|----|--------|-------|------|-------|--------|---------|--------|-------|
| EP-ROLES-01 | POST | /api/data/roles/batch | authenticated | body: BatchRolesDto | result | RolesDataService | done | |
...
| EP-ROLES-05 | POST | /api/data/roles | authenticated | body | created | RolesDataService | done | FE gates roles.manage |
| EP-ROLES-06 | PATCH | /api/data/roles/:id | authenticated | body | updated | RolesDataService | done | |
| EP-ROLES-07 | DELETE | /api/data/roles/:id | authenticated | param | ok | RolesDataService | done | |
